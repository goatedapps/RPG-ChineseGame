...
export function createCollection({ overlay, getActive, persist, render, toast, audio }) {
  ...
  function bag() {
    ...
    const illustratedKeys = ['cave-lantern', 'dawn-stroke', 'market-seal', 'truth-stroke', 'harbour-chronometer', 'current-stroke', 'lantern-stage-pass', 'courage-stroke', 'festival-medallion', 'harmony-stroke'];
