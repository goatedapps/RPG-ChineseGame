const CACHE = 'word-spirit-quest-p12-v22';
const CORE = [
  ...
  './content/authored/campaign/regions.json', './content/authored/campaign/maps/r1-hub.json', './content/authored/campaign/maps/r2-harvest-crossing.json', './content/authored/campaign/maps/r3-tidewater-bay.json',
  './content/authored/campaign/r1-story.json', './content/authored/campaign/r1-sets.json', './content/authored/campaign/r2-story.json', './content/authored/campaign/r2-sets.json', './content/authored/campaign/r3-story.json', './content/authored/campaign/r3-sets.json', './content/authored/campaign/daily-quests.json',
...
const RUNTIME = [
  ...
  './assets/images/rewards/cave-lantern.png', './assets/images/rewards/dawn-stroke.png', './assets/images/rewards/market-seal.png', './assets/images/rewards/truth-stroke.png', './assets/images/rewards/harbour-chronometer.png', './assets/images/rewards/current-stroke.png',
