const CACHE = 'word-spirit-quest-p18-v33';
const CORE = [
...
const RUNTIME = [
  ...
  './src/core/audio.js', './src/core/events.js', './src/core/progression.js', './src/core/rng.js', './src/core/safe.js', './src/core/save.js', './src/core/state.js', './src/core/time.js',
  ...
  './assets/images/hero/main-hero.png', './assets/images/hero/hero-walking.png', './assets/images/shop/shop-background.png', './assets/images/room/grandmas-room.png',
  './assets/images/intro/dictionary-tree.png', './assets/images/intro/great-forgetter.png', './assets/images/intro/spirits-scattered.png', './assets/images/story/open-book.png', './assets/images/story/reading-scroll.png',
